...
<form action="{{$url}}" method="post" enctype="multipart/form-data" class="file-upload">
    ...
    <div class="image-upload-wrap">
        ...
        <div class="drag-text">
            <h3>Kéo và thả ảnh của bạn vào đây</h3>
        </div>
    </div>
    <div class="file-upload-content">
        <img class="file-upload-image" src="#" alt="your image"/>
        <div class="image-title-wrap">
            <button type="button" onclick="removeUpload()" class="remove-image">Xóa <span class="image-title">Uploaded Image</span>
            </button>
        </div>
    </div>
    <br>
    <br>
    <br>
    <button class="file-upload-btn" type="submit">Tải lên
    </button>
</form>
</body>
